...
mod tests {
    ...
    // Tests for LD D,r instructions (0x50-0x57)
    #[test]
    fn test_ld_d_b() {
        let mut gb = GameBoy::new();
        gb.cpu.registers.b = 0x42;
    ...
    // Tests for LD E,r instructions (0x58-0x5F)
    #[test]
    fn test_ld_e_b() {
        let mut gb = GameBoy::new();
    ...
    // Tests for LD H,r instructions (0x60-0x67)
    #[test]
    fn test_ld_h_b() {
        let mut gb = GameBoy::new();
    ...
    // Tests for LD L,r instructions (0x68-0x6F)
    #[test]
    fn test_ld_l_b() {
        let mut gb = GameBoy::new();
